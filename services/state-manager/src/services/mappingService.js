...
class MappingService {
    ...
    async cacheMapping(mapping) {
        ...
        await redisClient.setEx(`mapping:wa:${mapping.wa_id}`, ttl, JSON.stringify(cacheData));
        await redisClient.setEx(`mapping:conv:${mapping.conversation_id}`, ttl, JSON.stringify(cacheData));
    }
